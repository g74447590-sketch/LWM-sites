...
const dashboardCopy: Record<Locale, Record<string, string>> = {
  "pt-BR": { greeting: "Olá", subtitle: "Crie, revise e evolua seus sites em um só lugar.", create: "Criar novo site", projects: "Projetos", ready: "Prontos para revisar", published: "Sites publicados", myProjects: "Meus projetos", total: "no total", updated: "Atualizado em", editor: "Editor", rename: "Renomear", duplicate: "Duplicar", unpublish: "Despublicar", publish: "Publicar", view: "Ver site", delete: "Excluir", emptyTitle: "Nenhum projeto ainda.", emptyBody: "Comece descrevendo o site que deseja criar.", confirmDelete: "Excluir este projeto? Esta ação não pode ser desfeita.", newName: "Novo nome do projeto", updateError: "Não foi possível atualizar o projeto.", deleteError: "Não foi possível excluir o projeto.", statusPublished: "Publicado", statusReady: "Pronto", statusGenerating: "Gerando…", statusError: "Requer configuração", statusDraft: "Rascunho" },
  en: { greeting: "Hello", subtitle: "Create, review and improve your sites in one place.", create: "Create new site", projects: "Projects", ready: "Ready to review", published: "Published sites", myProjects: "My projects", total: "total", updated: "Updated", editor: "Editor", rename: "Rename", duplicate: "Duplicate", unpublish: "Unpublish", publish: "Publish", view: "View site", delete: "Delete", emptyTitle: "No projects yet.", emptyBody: "Start by describing the site you want to create.", confirmDelete: "Delete this project? This action cannot be undone.", newName: "New project name", updateError: "We couldn't update the project.", deleteError: "We couldn't delete the project.", statusPublished: "Published", statusReady: "Ready", statusGenerating: "Creating…", statusError: "Needs setup", statusDraft: "Draft" },
  es: { greeting: "Hola", subtitle: "Crea, revisa y mejora tus sitios en un solo lugar.", create: "Crear nuevo sitio", projects: "Proyectos", ready: "Listos para revisar", published: "Sitios publicados", myProjects: "Mis proyectos", total: "en total", updated: "Actualizado", editor: "Editor", rename: "Renombrar", duplicate: "Duplicar", unpublish: "Despublicar", publish: "Publicar", view: "Ver sitio", delete: "Eliminar", emptyTitle: "Aún no hay proyectos.", emptyBody: "Empieza describiendo el sitio que quieres crear.", confirmDelete: "¿Eliminar este proyecto? Esta acción no se puede deshacer.", newName: "Nuevo nombre del proyecto", updateError: "No fue posible actualizar el proyecto.", deleteError: "No fue posible eliminar el proyecto.", statusPublished: "Publicado", statusReady: "Listo", statusGenerating: "Creando…", statusError: "Requiere configuración", statusDraft: "Borrador" },
};
...
export function DashboardClient({ initialProjects, userName }: { initialProjects: Project[]; userName?: string | null }) {
  ...
  return <main className="dashboard">
    <header className="dashboard-header"><div><p className="eyebrow">WORKSPACE</p><h1>{copy.greeting}{userName ? `, ${userName}` : ""}.</h1><p>{copy.subtitle}</p></div><div className="dashboard-actions"><Link className="button button-primary" href="/create">{copy.create}</Link><LogoutButton /></div></header>
