...
export function LandingPage() {
  ...
  return <>
    ...
    <main>
      ...
      <section className="pricing-teaser" aria-labelledby="pricing-teaser-title"><div><p className="eyebrow">PREÇO SEM SURPRESA</p><h2 id="pricing-teaser-title">Sites profissionais a partir de R$ 19 por mês.</h2><p>Uma alternativa simples para pequenos negócios: sem créditos por uso, sem dólar e sem depender de IA paga.</p></div><Link href="/planos" className="button button-ghost">Ver planos e comparação</Link></section>
