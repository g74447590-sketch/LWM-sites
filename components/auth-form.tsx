...
const authCopy: Record<Locale, {
  eyebrow: string; registerTitle: string; loginTitle: string; registerDescription: string; loginDescription: string;
...
export function AuthForm({ mode }: { mode: "login" | "register" }) {
  ...
  return <main className="auth-page"><div className="auth-card"><Logo /><p className="eyebrow">{copy.eyebrow}</p><h1>{isRegister ? copy.registerTitle : copy.loginTitle}</h1><p>{isRegister ? copy.registerDescription : copy.loginDescription}</p>
